    ...
    return declare([_View, DestroyableByKey], {
        ...
        _getEditableNodes: function (doc) {
            ...
            array.forEach(nodes, function (node) {
                var propertyNodeName = epiString.pascalToCamel(domAttr.get(node, "data-epi-edit") || domAttr.get(node, "data-epi-property-name"));
                ...
                if (propertyMetadata != null && propertyMetadata.showForEdit) {
                    ...
                    var rendererClass = domAttr.get(node, "data-epi-edit") ? "none" : domAttr.get(node, "data-epi-property-render") || propertyMetadata.customEditorSettings.rendererClass;
                    ...
                    result.push({
                        ...
                        property: {
                            ...
                            wrapperType: domAttr.get(node, "data-epi-edit") ? "floating" : domAttr.get(node, "data-epi-property-edittype"),
