...
// dojo
    ...
    return declare([_Command], {
        ...
        // useVersionSpecificLinkInResult: [protected] Boolean
        //      Should use version specific link in dialog result
        useVersionSpecificLinkInResult: false,
        ...
        _createDialog: function (/*object*/dialogParams, /*object*/routeParams) {
            ...
            var standardDialogParams = {
                ...
                onClose: lang.hitch(this, function () {
                    var contentReference = this.getContentReference(this.useVersionSpecificLinkInResult);
