...
namespace Alloy.Models.Pages
{
    ...
    public class StartPage : SitePageData
    {
        ...
        [UIHint("RelatedLinksWithMedia")]
        [Display(GroupName = Global.GroupNames.SiteSettings, Order = 330)]
        [BackingType(typeof(PropertyRelatedLinksWithMedia))]
        public virtual RelatedLinksWithMedia RelatedLinksWithMedia { get; set; }

        [UIHint("RelatedLinksWithMediaCollection")]
        [Display(GroupName = Global.GroupNames.SiteSettings, Order = 335)]
        [BackingType(typeof(PropertyRelatedLinksWithMediaCollection))]
        public virtual IEnumerable<RelatedLinksWithMedia> RelatedLinksWithMedias { get; set; }
