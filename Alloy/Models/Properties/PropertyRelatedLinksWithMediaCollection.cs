...
{
    [EditorHint("RelatedLinksWithMediaCollection")]
    [PropertyDefinitionTypePlugIn(Description = "Some description todo", DisplayName = "Related Links With Media Collection")]
    public class PropertyRelatedLinksWithMediaCollection : PropertyLongString
    {
        public override Type PropertyValueType
        {
            //defines the return type, This will return type of RelatedLinksWithMedia when the content is parsed to the view
            get { return typeof(IEnumerable<RelatedLinksWithMedia>); }
        }
        ...
        public override object Value
        {
            get
            {
                ...
                return serializer.Deserialize(value, typeof(IEnumerable<RelatedLinksWithMedia>));
            }
            set
            {
